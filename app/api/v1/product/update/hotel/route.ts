...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.log('🔄 Updating hotel product:', body);

    const backendUrl = `${PRODUCT_BASE_URL}/update/hotel`;
    ...
    return await handleBackendResponse(backendResponse, {
      ...
      fallbackMessage: 'Failed to update hotel product'
    });
  } catch (error) {
    console.error('❌ Update Hotel Product API Error:', error);
