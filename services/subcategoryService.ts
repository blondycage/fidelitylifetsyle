...
let subcategoriesCache: string[] | null = null;
...
/**
 * Fetch subcategories for a vendor
 */
export const getSubcategories = async (vendorId: number): Promise<string[]> => {
  try {
    // Check cache first
    ...
    console.log('🌐 Fetching subcategories from backend...');
